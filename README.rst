...
django-twoscoops-project, run the following command::
    ...
    $ django-admin.py startproject --template=https://github.com/julio-menendez/django-sass-project/archive/develop.zip --extension=py,rst,html,json,js icecream_project

For Django 1.5 users, we recommend::

    $ django-admin.py startproject --template=https://github.com/julio-menendez/django-sass-project/archive/1.5.zip --extension=py,rst,html,json,js icecream_project
